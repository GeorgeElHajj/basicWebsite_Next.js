export default function Services() {
    return (
        ...
        <div className="flex sm:flex-row flex-col sm:flex-nowrap flex-wrap sm:justify-normal justify-center">
            <div className="sm:w-1/5 w-1/2  mx-4 m-4 border border-gray-300 rounded-md shadow-lg shadow-black box-border ">
                <div className="image">
