    ...
    return (
        <header className="fixed top-0	w-full	z-10 bg-bl p-4 text-center	flex justify-between items-center ">
            ...
            <ul className={!burgerBtn ? "hidden sm:flex text-white items-center justify-center p-0 list-none sm:static  sm:flex-row sm:inset-0 "
                    ...
                    <li className=" text-white sm:mr-4 mr-0 sm:mb-0 mb-4 text-lg"><Link href="/" className={`${router==='/' ? "bg-gray-700": "" } hover:bg-gray-700 px-4 py-2 rounded}`}>Home</Link></li>
                    <li className="text-white sm:mr-4 mr-0 sm:mb-0 mb-4 text-lg	"><Link href="/services"  className={`${router==='/services' ? "bg-gray-700 ": "" } hover:bg-gray-700 px-4 py-2 rounded}`}>Services</Link></li>
                    <li className="text-white sm:mr-4 mr-0 sm:mb-0 mb-4 text-lg	"><Link href="/contactus"  className={`${router==='/contactus' ? "bg-gray-700  ": "" } hover:bg-gray-700 px-4 py-2 rounded}`}>Contact</Link></li>
                </ul>
            </nav>
